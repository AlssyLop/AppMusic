  ...
  musicalGenres:MusicalGenre[] = [
    {
      ...
      iconicSongs: ['"Thriller" (Michael Jackson)', '"Dancing Queen" (ABBA)', '"Yesterday" (The Beatles)', '"Bohemian Rhapsody" (Queen)'],
      color: '#850C03', 
    ...
    },
    {
      ...
      iconicSongs: ['"Stairway to Heaven" (Led Zeppelin)', '"Smells Like Teen Spirit" (Nirvana)', '"Highway to Hell" (AC/DC)', '"(I Can\'t Get No) Satisfaction" (The Rolling Stones)'],
      color: '#126E82',
    ...
    },
    {
      ...
      iconicSongs: ['"Rapper\'s Delight" (The Sugarhill Gang)', '"Nuthin\' but a \'G\' Thang" (Dr. Dre ft. Snoop Dogg)', '"Juicy" (The Notorious B.I.G.)', '"Lose Yourself" (Eminem)'],
      color: '#665527',
    ...
    },
    {
      ...
      iconicSongs: ['"One More Time" (Daft Punk)', '"Levels" (Avicii)', '"Blue Monday" (New Order)', '"Sandstorm" (Darude)'],
      color: '#27124D',
    ...
    },
    {
      ...
      iconicSongs: ['"What a Wonderful World" (Louis Armstrong)', '"Take Five" (Dave Brubeck Quartet)', '"Fly Me to the Moon" (Frank Sinatra/Bart Howard)', '"\'Round Midnight" (Thelonious Monk)'],
      color: '#4A4645',
